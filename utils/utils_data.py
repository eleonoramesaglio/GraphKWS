...
def preprocess_audio_OLD(file_path, label, sample_rate, frame_length, frame_step, gammatone = False, noise = False, spec_augmentation = False, noise_type = 'random', noise_prob = 0.8, min_snr_db = -5, max_snr_db = 10):
    ...
    if spec_augmentation:
        spectrogram = spec_augment_easy(spectrogram, freq_param = 3, time_param = 8, mode = 'all')
...
def apply_mel_filterbanks(spectrogram, sample_rate = 16000):
    ...
    min_frequency = 100  # to filter out some background noise, we look at frequencies from 100 ...
